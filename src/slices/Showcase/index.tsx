      ...
      <div className="flex flex-col md:flex-row gap-16 justify-center items-center">
        {slice.items.map((item) => (
          ...
          >
            ...
            >
              <h3 className="transition-[margin] mb-0 group-hover:mb-3 ${item.title.length > 10 ? 'text-6xl' : item.title.length > 5 ? 'text-5xl' : 'text-6xl'} font-black text-center  tracking-widest font-mono">
                {item.title}
              </h3>
