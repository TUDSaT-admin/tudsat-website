      ...
      <div className="absolute top-0  w-full h-full  overflow-hidden">
        <div className="absolute w-full h-full top-0 left-0 -z-30">
          <PrismicNextImage
            ...
            height={300}
            width={300}
            className="absolute transform-gpu origin-top-left animate-fly h-[300px] w-auto object-contain  md:-rotate-15 md:h-[400px]"
        ...
        <div className="absolute w-[80vmin] h-[80vmin] -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] -z-30">
          <div className="w-full h-full animate-spin" style={{ animationDuration: "60s" }}>
            <PrismicNextImage
              ...
              height={300}
              width={300}
              className="h-[100px] w-auto object-contain md:h-[150px] -rotate-30"
      ...
      <div className="relative isolate px-0 lg:px-8 w-full">
        <div className="relative mx-auto max-w-2xl pb-32 sm:py-24 lg:py-36 z-20">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 max-w-[90%] md:max-w-[60%] m-auto backdrop-blur-xs">
              {slice.primary.body}
            </p>
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#BA45A7]/80 to-[#BA45A7]/40 opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
            style={{
              clipPath:
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-accent to-accent/10 opacity-40 sm:left-[calc(50%+36rem)] sm:w-288.75"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
