...
export default async function Footer() {
  ...
  return (
    <footer className="mt-14 sm:mt-16 md:mt-20 lg:mt-24 p-4 sm:p-6 bg-primary text-secondary-foreground flex flex-col sm:flex-row gap-4 items-center justify-between">
