...
export const formSchema = z.object({
  ...
  birthday: z.date({ error: "A date of birth is required." }),
  studies: z.string(),
              ...
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                ...
                <div className="space-y-2 leading-none">
                  ...
                  <FormDescription>
                    ...
                    results from the application: <br />- Name of the debtor{" "}
                    <br />- Complete address of the debtor <br />- IBAN account
                    number of the payer <br />- BIC of the debtor&rsquo;s bank{" "}
                    <br />
                    <br />
              ...
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                ...
                <div className="space-y-2 leading-none">
                  ...
                  <FormDescription>
                    ...
                    membership. <br />
                    <br />I have been informed that the personal data collected
                    within the scope of the aforementioned purposes will be
                    collected, processed, used and transmitted in compliance
                    with the EU General Data Protection Regulation. I have been
