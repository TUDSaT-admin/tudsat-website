...
export default function Bounded({
  ...
  const firstTypeBase = withExtraPadding
    ? "first-of-type:pt-18"
    : "first-of-type:pt-10";
  const firstTypeMd = withExtraPadding
    ? "md:first-of-type:pt-22"
    : "md:first-of-type:pt-14";
  const firstTypeLg = withExtraPadding
    ? "lg:first-of-type:pt-24"
    : "lg:first-of-type:pt-16";
